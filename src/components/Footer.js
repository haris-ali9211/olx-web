...
import { Container,Row,NavDropdown,Col,Dropdown } from 'react-bootstrap';
          ...
          <Container fluid>
            ...
            <ul className="nav nav-pills">
              <li className="nav-item">
               <Dropdown >
                 <Dropdown.Toggle className="allcat" variant="success" id="dropdown-basic">
                 ALL CATEGORIES
               </Dropdown.Toggle>

                <Dropdown.Menu>
                 <div>
                  <Container className="dropdown1">
                      <Row className="dropdown">
                        <Col sm={12} md={3} lg={3} className="dropdown">
                          
                          <ul >
                           <li className="pop"><p>Vehicles</p></li>                    
                           ...
                           <ul >
                           <li className="pop"><p>Mobiles</p></li>                    
                           ...
                           <ul >
                           <li className="pop"><p>Electronics & Home Appliances</p></li>                    
                           ...
                           <ul >
                           <li className="pop"><p>Property for Sale</p></li>                    
                        ...
                        <Col sm={12} md={3} lg={3}>
                          <ul >
                            <li className="pop"><p>Animals</p></li>                    
                         ...
                         <ul >
                          ...
                          <ul >
                            <li className="pop"><p>Business, Industrial & Agriculture</p></li>                    
                            <li><p>Medical & Pharma</p></li>
                            <li><p>Other Business & Industry</p></li>
                            <li><p>Agriculture</p></li>
                            <li><p>Construction & Heavy Machinery</p></li>
                            <li><p>Trade & Industrial</p></li>
                            <li><p>Food & Restaurants</p></li>
                            <li><p>Business for Sale</p></li>
                          </ul>

                          <ul >
                            <li className="pop"><p>Bikes</p></li>                    
                            <li><p>Scooters</p></li>
                            <li><p>ATV & Quads</p></li>
                            <li><p>Spare Parts</p></li>
                        ...
                        <Col sm={12} md={3} lg={3}>
                          <ul >
                            <li className="pop"><p>Fashion & Beauty</p></li>                    
                          ...
                          <ul >
                            ...
                            <li><p>Accounting & Finance</p></li>
                            <li><p>Human Resources</p></li>
                            <li><p>Clerical & Administration</p></li>
                            <li><p>Hotels & Tourism</p></li>
                            <li><p>IT & Networking</p></li>
                            <li><p>Sales</p></li>
                        ...
                        <Col sm={12} md={3} lg={3}>
                        <ul >
                           <li className="pop"><p>Services</p></li>                    
                           <li><p>Farm & Fresh Food</p></li>
                            ...
                            <li><p>Event Services</p></li>
                            <li><p>Electronics & Computer Repair</p></li>
                           ...
                           <ul >
                            <li className="pop"><p>Books, Sports & Hobbies</p></li>                    
